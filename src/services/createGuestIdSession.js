...
//         Authorization:
//           'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI0MmM4ZDM2NGNmYzJmOWFiMWQ4YmRhZmUxMGUxYjk1ZSIsIm5iZiI6MTczMTYxMDkyNC45MTk0ODg0LCJzdWIiOiI2NzM2MzIwNWUwNTgyM2JkOWM3YzU0NDAiLCJzY29wZXMiOlsiYXBpX3JlYWQiXSwidmVyc2lvbiI6MX0.X0kGNNFjYFO4nJloqT0D2dma_Oc9XP0RBRccOS0CLiY',
//       },
//     });
//
...
//       return sessionId;
//     } else {
//       console.error('Failed to create guest session:', response.status);
//     }
//   } catch (error) {
//     console.error(
//       'Error:',
